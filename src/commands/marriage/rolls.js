    ...
    async execute(client, message, args) {
        try {
            ...
            if (rollData.rollsRemaining === 0) {
                ...
                statusColor = '#FF4444';
            } else if (rollData.rollsRemaining <= 1) {
                statusEmoji = '🟡';
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    {
                        ...
                        value: `**${rollData.rollsRemaining}/3**`,
                        inline: true
                    },
                    {
                        name: '📊 Status',
                ...
                .setDescription(rollData.rollsRemaining > 0 ? 
                    ...
                    'Espera pelo próximo reset para receberes 3 rolls novos!')
                .setTimestamp()
                .setFooter({ 
            ...
            if (rollData.isNewHour) {
                embed.addFields({
                    ...
                    value: 'Acabaste de receber 3 rolls novos!',
                    inline: false
                });
            }
